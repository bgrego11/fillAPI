...
function StripeCheckoutForm(props) {
  ...
  //added for billing info
  const [billingCountry, setBillingCountry] = useState('');
  const [billingAdress1, setBillingAddress1] = useState('');
  ...
  const billingCountryUpdate = event => {
    setBillingCountry(event.target.value);
  }

  const billingAddress1Update = event => {
    setBillingAddress1(event.target.value);
  }

  const billingAddress2Update = event => {
    setBillingAddress2(event.target.value);
  }

  const billingCityUpdate = event => {
    setBillingCity(event.target.value);
  }

  const billingStateUpdate = event => {
    setBillingState(event.target.value);
  }

  const billingZipCodeUpdate = event => {
            ...
            <Col md={12}>
              <FormGroup>
                ...
                <Input
                  ...
                  id="billingAddress1"
                  placeholder=""
                  value={billingAdress1}
                  onChange={billingAddress1Update}
                />
              </FormGroup>
            </Col>
          </Row>
            ...
            <Col md={12}>
              <FormGroup>
                ...
                <Input
                  ...
                  onChange={billingAddress2Update}
                />
              </FormGroup>
            </Col>
          </Row>
